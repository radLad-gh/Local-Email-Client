  ...
  */
  ...
  public void displayInbox() {
	...
	public void favoriteEmail(int index) {
		try {
			...
			composer = new FileWriter("Users/" + chosenEmail.getSender() + "/Favorites/" + chosenEmail.getID());
  ...
  public void displayFavorites() {
    ...
    public void deleteEmail(int index) {
				Email chosenEmail = emails.get(index);
        File deleteFile = new File ("Users/" + chosenEmail.getSender() + currentPosition + chosenEmail.getID());
        // Delete the email
        deleteFile.delete();
